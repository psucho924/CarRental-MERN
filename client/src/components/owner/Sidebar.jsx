...
const Sidebar = () => {
  ...
  const updateImage = wrapAsync(async () => {
          ...
          <img
            ...
            src={
              image
                ...
                : user?.image || assets.profile_picture
            }
            alt=""
          />
          <input
      ...
      <div className="w-full">
        {ownerMenuLinks.map((link, index) => (
          <NavLink
            key={index}
            to={link.path}
            className={`relate flex items-center gap-2 w-full py-3 pl-4 first:mt-6 ${link.path === location.pathname ? "bg-primary/10 text-primary" : "text-gray-600"}`}
          >
            <img
              src={
