...
const ManageCars = () => {
  ...
  const fetchOwnerCars = wrapAsync(async () => {
  ...
  const toggleAvailability = wrapAsync(async (carId) => {
  ...
  const deleteCar = wrapAsync(async (carId) => {
  ...
  return (
    <div className="px-4 pt-10 md:px-10 w-full">
      <Title
        title="Manage Cars"
        subTitle="View all listed cars, update their details, or remove them from the booking plaform."
      />
